...
VAL_PQ="${DATA_DIR}/test.parquet" # 没用，随便一个数据集就行，不参与训练，训练过程中也不需要验证

REWARD_PY="./customized/my_initial_method_reward.py"
...
export SENTENCE_ENCODER_PATH="sentence-transformers/all-MiniLM-L6-v2"
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name='qwen3_8b_grpo_initial_method_my_initial_method_reward' \
